...
export const LaporanView: React.FC<LaporanViewProps> = ({
  ...
  // Calculate dynamic start/end date for current month
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
          ...
          <div className="flex items-center gap-1 bg-slate-900 border border-slate-700 rounded-lg p-0.5">
            {[
              ...
              <button
                ...
                className="px-2 py-1 text-[10px] font-bold rounded text-slate-300 hover:text-white hover:bg-slate-800 transition-colors"
              >
                {p.label}
              </button>
            ))}
          ...
          <div className="flex items-center gap-1.5">
            ...
            <input
              ...
              className="bg-slate-900 border border-slate-700 rounded-lg px-2 py-1 text-xs text-white font-medium outline-none"
            />
