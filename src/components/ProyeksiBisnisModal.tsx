...
_Kalkulasi Proyeksi Cerdas BebekJaya PRO Enterprise_`;
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-md p-2 sm:p-6 flex flex-col justify-center items-center animate-in fade-in duration-200">
      <div className="glass-panel-glow w-full max-w-4xl rounded-2xl sm:rounded-3xl p-4 sm:p-7 relative my-auto max-h-[92vh] overflow-y-auto border border-amber-500/30 shadow-2xl">
        {/* Header */}
