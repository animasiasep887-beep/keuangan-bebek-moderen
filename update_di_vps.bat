...
echo =========================================================
echo  [1] Mem-backup database & file .env produksi
echo  [2] Menarik kode terbaru dari GitHub (origin/main)
echo  [3] Memulihkan database transaksi & token produksi
echo  [4] Menginstall dependensi & build web application
...
echo.
echo =========================================================
echo    ✅ UPDATE SELESAI! WEBSITE TERNAK.FUN SUDAH AKTIF
echo =========================================================
